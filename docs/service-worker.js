...
"use-strict"
const CURRENT_CACHE_NAME='version-1.06';let filesToCache=['./','./index.html','./js/bundle.js','./style/style.css','./img/board.png','./img/peg.png','./img/pegHolder.png','./img/vintage-concrete.png','https://fonts.googleapis.com/css?family=Kalam:400,700','./img/icons/android-chrome-36x36.png','./img/icons/android-chrome-48x48.png','./img/icons/android-chrome-72x72.png','./img/icons/android-chrome-96x96.png','./img/icons/android-chrome-144x144.png','./img/icons/android-chrome-192x192.png','./img/icons/android-chrome-256x256.png','./img/icons/android-chrome-384x384.png','./img/icons/android-chrome-512x512.png','./img/icons/apple-touch-icon-57x57.png','./img/icons/apple-touch-icon-60x60.png','./img/icons/apple-touch-icon-72x72.png','./img/icons/apple-touch-icon-76x76.png','./img/icons/apple-touch-icon-114x114.png','./img/icons/apple-touch-icon-120x120.png','./img/icons/apple-touch-icon-144x144.png','./img/icons/apple-touch-icon-152x152.png','./img/icons/apple-touch-icon-180x180.png','./img/icons/apple-touch-icon.png','./img/icons/favicon-16x16.png','./img/icons/favicon-32x32.png','./img/icons/mstile-70x70.png','./img/icons/mstile-144x144.png','./img/icons/mstile-150x150.png','./img/icons/mstile-310x150.png','./img/icons/mstile-310x310.png','./manifest.json','./browserconfig.xml','./favicon.ico'];self.addEventListener('install',event=>{console.log("[ServiceWorker] Attempting to install service worker and cache files");event.waitUntil(addAllCacheFilesToCache(filesToCache,CURRENT_CACHE_NAME));});async function addAllCacheFilesToCache(files,cacheName)
